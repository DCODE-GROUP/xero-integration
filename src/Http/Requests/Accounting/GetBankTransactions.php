 ...
 * getBankTransactions
 */
class GetBankTransactions extends Request
{
	 ...
	 * @param null|int $page Up to 100 bank transactions will be returned in a single API call with line items details
